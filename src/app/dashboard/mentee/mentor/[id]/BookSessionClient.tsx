    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        <div className={`w-12 h-12 rounded-xl flex items-center justify-center shadow-lg ${
          isPro ? 'bg-gradient-to-br from-amber-400 to-orange-500' : 'bg-gradient-to-br from-emerald-400 to-teal-500'
        }`}>
          {isPro ? <Award className="w-6 h-6 text-white" /> : <Zap className="w-6 h-6 text-white" />}
        </div>
        <div>
      ...
      <div className="space-y-4">
        ...
        <button 
          ...
          className={`w-full py-4 rounded-xl font-bold text-white shadow-lg hover:shadow-xl transition-all active:scale-[0.98] flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed ${
            isPro 
