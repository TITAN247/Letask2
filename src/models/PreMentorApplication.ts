...
const PreMentorApplicationSchema = new mongoose.Schema({
    userId: {
...
export default mongoose.models.PreMentorApplication || mongoose.model('PreMentorApplication', PreMentorApplicationSchema);
